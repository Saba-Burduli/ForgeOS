...
using AiStartupOs.Modules.FounderCopilot.Infrastructure;
...
namespace AiStartupOs.Modules.FounderCopilot.Presentation;

public sealed class FounderCopilotModule : IModule
{
    public string Name => ModuleDefinition.Name;

    public void Register(IServiceCollection services, IConfiguration configuration)
    {
        services.AddFounderCopilotInfrastructure(configuration);
    }
